...
async def mwclass(ctx, Class, name=None):
    ...
    embed.add_field(name=f'{Class.capitalize()} Final Kills', value=f"`{'{:,}'.format(class_final_kills_all)}`")
    embed.add_field(name=f'{Class.capitalize()} Final Assists', value=f"`{'{:,}'.format(class_final_assists_all)}`")
    embed.add_field(name=f'{Class.capitalize()} FK/D Ratio', value=f"`{'{:,}'.format(class_fkd)}`")
    embed.add_field(name=f'{Class.capitalize()} Wins', value=f"`{'{:,}'.format(class_wins_all)}`")
    embed.add_field(name=f'{Class.capitalize()} Losses', value=f"`{'{:,}'.format(class_losses_all)}`")
    embed.add_field(name=f'{Class.capitalize()} Final Deaths', value=f"`{'{:,}'.format(class_final_deaths_all)}`")
    embed.add_field(name=f'{Class.capitalize()} W/L Ratio', value=f"`{'{:,}'.format(class_wlr)}`")   
    embed.add_field(name=f'{Class.capitalize()} Class Points', value=f"`{'{:,}'.format(class_cp)}`")
